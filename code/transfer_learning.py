...
def finetune(device, dataloaders, dataset_sizes, class_names):
    ...
    model_ft = train_model(device, dataloaders, dataset_sizes, model_ft, criterion, optimizer_ft, exp_lr_scheduler, num_epochs=10)
...
def freeze(device, dataloaders, dataset_sizes, class_names):
    ...
    print('Finetune the model')
    model_conv = train_model(device, dataloaders, dataset_sizes, model_conv, criterion, optimizer_conv, exp_lr_scheduler, num_epochs=10)
