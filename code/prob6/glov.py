...
class glov(nn.Module):
    ...
    """
    def __init__(self, input_dim=None, word_vec_dim=50, class_num=2, sentence_len = None, weight_matrix=None):
        """
...
if __name__ == '__main__':
    ...
    device = 'cpu'
    net = glov(input_dim=len(word_dic)+1, word_vec_dim=50, class_num=2, sentence_len=15, weight_matrix=weight_matrix).to(device)
